  ...
  return (
    <div className='flex flex-col gap-7 w-[280px]'>
        ...
        <div className='flex justify-center items-center gap-4 w-[300px]'>
            <ExperienceInfo number='3' text='Jahre'/>
            <p className='font-bold text-6xl text-lightBrown'>-</p>
            <ExperienceInfo number='6' text='Projekte'/>
        </div>
        <p className='text-center text-white'>Mit 3 Jahren Erfahrung in der Gestaltung und Entwicklung interaktiver Webseiten mit modernen Frameworks wie React und Vue</p>
        <ExperienceInfo/>   
    </div>
  )
}
